...
return [
    ...
    */
    ...
    'other' => [
        'number_format_7' => 'Значение поля :attribute имеет некорректный формат. Прим.: (999) 999-99-99',
        'number_format_375' => 'Значение поля :attribute имеет некорректный формат. Прим.: (099) 999-99-99',
    ],
];
